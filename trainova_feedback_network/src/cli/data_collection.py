...
class DataCollector:
    """
    Handles data collection, manipulation, and storage for the Trainova feedback network.
    ...
    def _get_validated_numeric_input(self, prompt: str, is_int: bool = False, default: Optional[float] = None) -> float:
        """
    ...
    def generate_mock_data(self, num_samples: int = 100, exercises: Optional[List[str]] = None) -> pd.DataFrame:
        """
        Generate mock workout data for pretraining with realistic progression rates.
